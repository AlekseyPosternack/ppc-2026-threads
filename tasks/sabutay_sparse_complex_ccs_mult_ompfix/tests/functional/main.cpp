...
class SabutayARunFuncTestsThreadsFix : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path =
          ppc::util::GetAbsoluteTaskPath(std::string(PPC_ID_sabutay_sparse_complex_ccs_mult_ompfix), "pic.ppm");
...
const auto kTestTasksList = std::tuple_cat(ppc::util::AddFuncTask<SabutaySparseComplexCcsMultOmpFix, InType>(
